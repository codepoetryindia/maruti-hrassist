...
const HolidayCalendar = () => {
    ...
    return (
      ...
      <View>
      {
        ...
        //       }
        //   }
         (HolidayCalendar == 0) ? (<View><Text>apply Leave</Text></View>) : (HolidayCalendar == 1)  ?(<View><Text> Leave</Text></View>) :(HolidayCalendar == 2) ? (<View><Text>View report</Text></View>) : (<View><Text>lasrt</Text></View>)
     }
      </View>
      </View>
